...
<div className="mb-8">
    <video controls className="w-full rounded-lg" style={{ maxHeight: '500px', width: '100%' }}>
        <source src="https://pub-ca9c0d913dd54c718ef046cad03c9ecd.r2.dev/videos/signal-2025-11-18-124020.mov" type="video/quicktime" />
        <source src="https://pub-ca9c0d913dd54c718ef046cad03c9ecd.r2.dev/videos/signal-2025-11-18-124020.mov" type="video/mp4" />
...
<div style={{ borderLeft: '3px solid #666', paddingLeft: '1.5rem', margin: '2.5rem 0', color: '#666' }}>

*__Update:__* At the time, our assumption was that the stimulation works by pressing on parts of the olfactory bulb via the [Acoustic Radiation Force](https://www.youtube.com/watch?v=ngIGqWq2twY). However, another likely explanation is that the ultrasound gets converted into a shear wave mode when passing through the skull, and then propagates *through the skull* to the olfactory flia — the small nerves passing into the skull.

<div style={{ display: 'flex', gap: '0.75rem', marginTop: '0.5rem' }}>
    <img src="/images/olfactory-filia-2.jpeg" alt="Olfactory flia passing through the cribriform plate" style={{ width: '45%', borderRadius: '2px', margin: 0 }} />
    <img src="/images/olfactory-filia-1.jpeg" alt="Olfactory flia close-up showing nerves entering the skull" style={{ width: '45%', borderRadius: '2px', margin: 0 }} />
</div>
...
We found different scents by steering the beam over \~14 mm (20 degrees at 4 cm radius). The distance between freshness and burning<Sidenote>Update: we later learned from Steven Pang that people often smell burnt toast before having a stroke. At first, this burning smell seemed oddly specific compared to our other, more general sensations. But the fact that a global neurological event can trigger the same smell suggests that burning is itself a higher-level sensation — not a specific receptor activation.</Sidenote> was \~3.5 mm. We ensured that the effect was not placebo with an auditory mask (blasting music through airpods) so you don’t hear the probe, though you cannot distinguish the different focal spots through sound anyways. We then tested discrimination in a trial where Thomas selected the focal spots, and Lev was naming the scents. You can check out the full video [here](https://drive.google.com/file/d/15unzKH91czjzKANmB-eiTck7f7kKphz-/view?usp=sharing).
