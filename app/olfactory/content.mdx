...
By focusing the energy delivered by ultrasound at different spots in the brain, we were able to trigger different smells. We reproduced the effect on our first try with two people and confirmed it in a blind trial. The smell and smell-like sensations we identified were:
<SmellList />
